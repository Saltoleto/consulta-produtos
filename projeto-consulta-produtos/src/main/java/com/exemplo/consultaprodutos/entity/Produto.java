 ...
 * Um produto pode estar associado a múltiplos operadores e usuários.
 */
@Entity
@Table(name = "produto", 
       indexes = {
...
public class Produto extends BaseEntity {
    ...
    public void adicionarUsuario(UsuarioProduto usuarioProduto) {
        usuarioProdutos.add(usuarioProduto);
        usuarioProduto.setProduto(this);
    }

    public void removerUsuario(UsuarioProduto usuarioProduto) {
        usuarioProdutos.remove(usuarioProduto);
        usuarioProduto.setProduto(null);
    }
